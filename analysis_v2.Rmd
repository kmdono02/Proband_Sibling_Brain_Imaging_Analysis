...
Now, we conduct the same linear regression analysis as was done before but also include a set of possible confouding variables for eahch model.  The variables are: study site for infant, age of the infant at MRI scan, and sex of infant.  We print the same output as in the previous linear regrsssion analysis.
...
for(i in 1:length(brain_vars)){
  ...
  sort_vec <- 
    c("(Intercept)", "SCQ_Pro_Score", "Cand_SexMale", "RiskGroupHR-ASD",
      "RiskGroupHR-ASD:SCQ_Pro_Score",  "RiskGroupHR-ASD:AgeMRI", "SiteSEA", "SiteSTL", "SiteUNC","AgeMRI")
...
for(i in 1:length(brain_vars)){
  ...
  sort_vec <- c("(Intercept)", "SCQ_Pro_Score", "Cand_SexMale", "RiskGroupHR-ASD",
